...
function ComponentModal(props) {
  ...
  const sendEmail = (event) =>{
    ...
    emailjs.sendForm('service_4murwr9', 'template_6e3ngob', event.target, 'U-PzORJFBqhiAuRp2')
  ...
  return (
    <>
      <Button variant="primary" className='ButtonCommentForm' onClick={handleShow}>
        Report Comment
      </Button>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <button className="buttonModalForm" type="submit" onClick={handleClose}>
          Send
        </button>
        </div>
      </form>
